...
if ($actual != 'admin') {
    ...
    $consulta = "INSERT INTO pregunta (id_Usuario, id_Sede, pregunta, usuario_origen, usuario_destino) 
VALUES ('$actual','$sedeId', '$pregunta', '$actual', 'admin')";
...
?>
    ...
    $consulta = "INSERT INTO pregunta (id_Usuario, id_Sede, pregunta, usuario_origen, usuario_destino) 
VALUES ('$odontoSelecc','$sedeId', '$pregunta', '$actual', '$odontoSelecc')";
    $envio = mysqli_query($conn, $consulta);
