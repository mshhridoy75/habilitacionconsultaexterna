...
$consulta2 = "SELECT id
FROM pp_politica 
where id_Usuario='$actual' AND id_Sede='$sedeId' AND id_Estandar=5 AND politica='$politica'";
$envio2 = mysqli_query($conn, $consulta2);
$row = $envio2->fetch_assoc();
$idPol = $row['id'];



$consulta = "INSERT INTO pp_objetivos (id_Usuario, id_Sede, id_Estandar, politica, objetivos) 
VALUES ('$actual','$sedeId', 5, '$idPol', '$objetivo')";
...
?>
    ...
    <body class="fondo-dos">
        ...
        <div class="succ text-center">
            ...
            <div class="col-12">
                <h5>Se registró la politica correctamente</h1>
            </div>
...
?>
    ...
    <body class="fondo-dos">
        ...
        <div class="succ text-center">
            ...
            <div class="col-12">
                <h5>No se registró la politica</h1>
            </div>
