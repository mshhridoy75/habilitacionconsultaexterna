...
if ($newpass == $newpassconfr) {
    ...
    $consulta = "UPDATE usuario SET password = '$hashed_password' WHERE id='$id'";
...
?>
        ...
        <body class="fondo-dos">
            ...
            <div class="succ text-center">
                ...
                <div>
                    <a class="btn btn-success col col-md-auto" href="../../principalOdontologo.php?sedeSel=<?php echo $sede ?>&actual=<?php echo $usuario ?>">Continuar</a>
                </div>
    ...
    <body class="fondo-dos">
        ...
        <div class="succ text-center">
            ...
            <div>
                <a class="btn btn-danger col col-md-auto" href="../../principalOdontologo.php?sedeSel=<?php echo $sede ?>&actual=<?php echo $usuario ?>">Continuar</a>
            </div>
