...
$consulta = "INSERT INTO `hc_evolucion`(`id_Usuario`, `id_Sede`, `id_Estandar`, `id_persona`, `fecha`, `tratamiento`, `nombre_odonto`, `paciente`)
VALUES ('$actual','$sedeId', 6, '$cedula', '$fecha', '$tratamiento', '$firma_dr', '$firma_paciente')";
...
?>
    ...
    <body class="fondo-dos">
        ...
        <div class="succ text-center">
            ...
            <div class="col-12">
                <h5>Se registró el la evolucion correctamente</h1>
            </div>
...
?>
    ...
    <body class="fondo-dos">
        ...
        <div class="succ text-center">
            ...
            <div class="col-12">
                <h5>No se registró la evolucion</h1>
            </div>
