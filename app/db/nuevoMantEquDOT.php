...
$nom1 = $_FILES['soporte']['name'];
$tmp1 = $_FILES['soporte']['tmp_name'];
$ruta = "../docs/Soporte/" . $nom1;
...
?>
    ...
    <body class="fondo-dos">
        ...
        <div class="succ text-center">
            ...
            <div class="col-12">
                <h5>Se registró el mantenimiento correctamente</h1>
            </div>
...
?>
    ...
    <body class="fondo-dos">
        ...
        <div class="succ text-center">
            ...
            <div class="col-12">
                <h5>No se registró el mantenimiento</h1>
            </div>
