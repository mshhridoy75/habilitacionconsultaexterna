...
WHERE sede_odonto.id ='$odont'";
//"SELECT nombre FROM sede JOIN sede_odonto ON sede.id=sede_odonto.id WHERE sede_odonto.id='$odont'";
                                ...
                                ?>
                                    ...
                                    <div class="row justify-content-md-center">
                                        ...
                                        <form method="POST" action="gestionAdmin.php?sedeSel=<?php echo $sede ?>&usuarioSel=<?php echo $odont ?>&actual=<?php echo $actual ?>">
